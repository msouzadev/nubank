  ...
  return (
    ...
    >
      <CloseModalContainer onPress={() => { onClose && onClose(); setOpen(false); }}>
        <CloseModalView style={{ flex: 6, backgroundColor: '#222', opacity: 0.3 }} />
      </CloseModalContainer>
      <View style={{ flex: 3, backgroundColor: '#FFF', justifyContent: 'center', alignContent: 'center', alignItems: "center" }}>

        <Icon name="lock-outline" size={50} color="#404040" />
        <BlockQuestion>
          Você quer <Strong>bloquear</Strong> <Strong>temporariamente</Strong> o seu cartão?
            </BlockQuestion>

      </View>
      <Footer flex={1}>
        <View style={{ flex: 1, borderRightWidth: 1, borderRightColor: '#cccccc', justifyContent: 'center', alignItems: 'center' }}>
